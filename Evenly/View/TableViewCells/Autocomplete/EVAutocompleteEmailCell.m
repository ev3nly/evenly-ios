...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(LABEL_MARGIN,
                                                                   0,
        ...
        self.emailLabel = [[UILabel alloc] initWithFrame:CGRectMake(LABEL_MARGIN,
        ...
        self.emailLabel.adjustsLetterSpacingToFitWidth = YES;
